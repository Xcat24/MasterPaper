...
model.summary()
plot(model, to_file='/home/xcat/experiment/BCI2008/ds1a/model/1*128sgd.png', show_shapes=True)
...
checkpointer = ModelCheckpoint(filepath='/home/xcat/experiment/BCI2008/ds1a/model/1*128mlp_sgd0.01.h5',verbose=1,save_best_only=True, monitor='val_acc')
