#!/usr/bin/env python
'''change 2 LSTM layers to 1 mlp layer
'''
...
model.summary()
plot(model, to_file='/home/xcat/experiment/BCI2008/ds1a/model/1*128mlp_adam0.0005.png', show_shapes=True)
...
checkpointer = ModelCheckpoint(filepath='/home/xcat/experiment/BCI2008/ds1a/model/1*128mlp_adam0.0005.h5',verbose=1,save_best_only=True, monitor='val_acc')

model.fit(X_train, Y_train, batch_size=batch_size, nb_epoch=nb_epoch,
          verbose=1, validation_data=(X_test, Y_test), callbacks=[checkpointer])

#model.save('/home/xcat/MasterPaper/model/1*128mlp_RMSprop_lr0.001.h5')
