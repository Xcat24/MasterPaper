#!/usr/bin/env python
'''change 2 LSTM layers to 2 mlp layers
'''
...
model.summary()
plot(model, to_file='/home/xcat/experiment/BCI2008/ds1a/model/2*128mlp.png', show_shapes=True)
...
model.compile(loss='categorical_crossentropy',
              optimizer=opt,
              metrics=['accuracy'])
checkpointer = ModelCheckpoint(filepath='/home/xcat/experiment/BCI2008/ds1a/model/2*128mlp_sgd0.01.h5',verbose=1,save_best_only=True, monitor='val_acc')

model.fit(X_train, Y_train, batch_size=batch_size, nb_epoch=nb_epoch,
          verbose=1, validation_data=(X_test, Y_test), callbacks=[checkpointer])

#model.save('/home/xcat/MasterPaper/model/2*128mlp_RMSprop_lr0.001.h5')
#model.save('/home/xcat/MasterPaper/model/2*128mlp_Adam_lr0.002.h5')
#model.save('/home/xcat/MasterPaper/model/2*128mlp_sgd_lr0.01.h5')
