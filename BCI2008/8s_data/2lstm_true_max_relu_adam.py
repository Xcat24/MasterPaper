...
import numpy as np
np.random.seed(1747)  # for reproducibility
...
X_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/8s_data/train.npy')
y_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/8s_data/label.npy')
#scale data
...
modelname = '2LSTM_true_max_relu_adam'
save_path = '/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/model/8s_data/'

plot(model, to_file=save_path+modelname+'.png', show_shapes=True)

opt = Adam()
model.compile(loss='categorical_crossentropy',
              optimizer=opt,
              metrics=['accuracy'])
checkpointer = ModelCheckpoint(filepath=save_path+modelname+'.h5',verbose=1,save_best_only=True, monitor='val_acc')
