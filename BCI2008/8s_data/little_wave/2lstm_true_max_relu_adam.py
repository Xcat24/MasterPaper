...
X_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/all_4000.npy')
...
modelname = '4000_2LSTM_true-adam_max_relu'

plot(model, to_file='/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/model/little_wave/'+modelname+'.png', show_shapes=True)

opt = Adam()
model.compile(loss='categorical_crossentropy',
              optimizer=opt,
              metrics=['accuracy'])
checkpointer = ModelCheckpoint(filepath='/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/model/little_wave/'+modelname+'.h5',verbose=1,save_best_only=True, monitor='val_acc')
