...
model.add(Reshape((1,2000,40*59)))
...
model.summary()
plot(model, to_file='/home/xcat/experiment/BCI2008/ds1a/model/model_2.4.png', show_shapes=True)
...
model.save('/home/xcat/experiment/BCI2008/ds1a/model/model_2.4_RMSprop_lr0.001.h5')
