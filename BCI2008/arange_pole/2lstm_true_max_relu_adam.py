...
X_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/arange_pole/train.npy')
y_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/arange_pole/label.npy')
#scale data
...
modelname = 'cube_cnn_2lstm_max_relu'
