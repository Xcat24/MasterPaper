...
X_data = np.load('/media/xcat/9A8821088820E48B/Fang/allsubs_train.npy')
y_data = np.load('/media/xcat/9A8821088820E48B/Fang/allsubs_label.npy')
#print('x_data:',X_data[0,0:10,:])

X_train = np.vstack((X_data[:488,:,:,:], X_data[549:1020,:,:,:]))   #.transpose((0,2,1))
X_test = np.vstack((X_data[488:549,:,:,:], X_data[1020:,:,:,:]))     #.transpose((0,2,1))
Y_train = np.hstack((y_data[:488], y_data[549:1020]))
Y_test = np.hstack((y_data[488:549], y_data[1020:]))
...
modelname = 'allsubs_2cnn_mr_onFang_data'
