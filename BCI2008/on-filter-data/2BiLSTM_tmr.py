...
X_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/filtered-train.npy')
y_data = np.load('/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/filtered-label.npy')
#scale data
...
modelname = '2BiLSTM_tmr'

plot(model, to_file='/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/model/on-filtered-data/'+modelname+'.png', show_shapes=True)

opt = Adam()
model.compile(loss='categorical_crossentropy',
              optimizer=opt,
              metrics=['accuracy'])
checkpointer = ModelCheckpoint(filepath='/media/kong/9A8821088820E48B/Xcat/experiment/BCI2008/ds1a/model/on-filtered-data/'+modelname+'.h5',verbose=1,save_best_only=True, monitor='val_acc')
