...
X_train = np.load('/media/kong/9A8821088820E48B/ImageNet_data/train_data.npy')
Y_train = np.load('/media/kong/9A8821088820E48B/ImageNet_data/train_label.npy')
X_test = np.load('/media/kong/9A8821088820E48B/ImageNet_data/test_data.npy')
Y_test = np.load('/media/kong/9A8821088820E48B/ImageNet_data/test_label.npy')
#scale data
...
plot(model, to_file='/home/xcat/experiment/BCI2008/ds1a/model/'+modelname+'.png', show_shapes=True)

opt = Adam()
model.compile(loss='categorical_crossentropy',
              optimizer=opt,
              metrics=['accuracy'])
checkpointer = ModelCheckpoint(filepath='/home/xcat/experiment/BCI2008/ds1a/model/'+modelname+'h5',verbose=1,save_best_only=True, monitor='val_acc')
